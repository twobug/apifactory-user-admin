    ...
    <el-dialog :title="pushData.dialogTitle" :visible.sync="pushData.dialogFormVisible" :close-on-click-modal="false" :close-on-press-escape="false">
      <el-form :rules="rules" ref="addEditPopForm" :model="pushData" label-position="left" label-width="100px">
        <el-form-item label="连续签到" prop="continuous">
          <el-input-number v-model="pushData.continuous" :min="1" clearable @keyup.enter.native="handleCreateSave" style="width: 97%;"></el-input-number>&nbsp;天
        </el-form-item>
        <el-form-item label="积分" prop="score">
          <el-input-number v-model="pushData.score" :min="1" clearable @keyup.enter.native="handleCreateSave" style="width: 97%;"></el-input-number>
        </el-form-item>
      </el-form>
